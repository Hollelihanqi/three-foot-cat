<template>
  <div class="table-box">
    <div class="table-top-box">
      <el-button type="primary" @click="handleClick(0)">新建分组</el-button>
      <el-button type="primary" @click="handleClick(1)">优先级设置</el-button>
    </div>
    <BaseTable
      :columns="columns"
    ...
    >
      <template #action="scope">
        ...
        <i class="el-icon-minus vhi" />
        <el-button style="color: #2c3cd8" type="text" @click="handleDelete(scope.row)">重置排班</el-button>
        <i class="el-icon-minus vhi" />
        <el-button style="color: #2c3cd8" type="text" @click="handleDelete(scope.row)">一键开牌</el-button>
        <i class="el-icon-minus vhi" />
        <el-button style="color: #2c3cd8" type="text" @click="handleDelete(scope.row)">一键盖牌</el-button>
        <i class="el-icon-minus vhi" />
        <el-button style="color: #2c3cd8" type="text" @click="handleDelete(scope.row)">钟数清零</el-button>
      </template>
    </BaseTable>
  </div>
