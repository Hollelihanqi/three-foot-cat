  ...
  <div class="table-box">
    ...
    >
      <template #action="scope">
        <el-button style="color: #2c3cd8" type="text" @click="handleEdit(scope.row)">权限配置</el-button>
        <i class="el-icon-minus vhi" />
        <el-button style="color: #2c3cd8" type="text" @click="handleEdit(scope.row)">使用默认配置</el-button>
      </template>
    </BaseTable>
  </div>
