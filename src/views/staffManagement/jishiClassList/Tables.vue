<template>
  <div class="table-box">
    <div class="table-top-box">
      <el-button type="primary" @click="handleClick(0)">新建班次</el-button>
      <el-button type="primary" @click="handleClick(1)">值班设置</el-button>
    </div>
    <BaseTable
      :columns="columns"
    ...
    >
      <template #action="scope">
        ...
        <i class="el-icon-minus vhi" />
        <el-button style="color: #2c3cd8" type="text" @click="handleDelete(scope.row)">班次对调</el-button>
        <i class="el-icon-minus vhi" />
        <el-button style="color: #2c3cd8" type="text" @click="handleDelete(scope.row)">下班队列记录</el-button>
      </template>
    </BaseTable>
  </div>
