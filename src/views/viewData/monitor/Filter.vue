<template>
  <BaseFilterBox>
    <el-form class="filter-form" ref="formInstance" inline :model="store.queryParams" label-width="80px" inline-message>
      ...
      <BaseFormItem w="120px" label="包厢号" v-model="store.queryParams.keyword" placeholder="" />
      <BaseFormItem w="120px" label="技师号" v-model="store.queryParams.keyword" placeholder="" />
    </el-form>
