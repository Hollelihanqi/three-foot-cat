<template>
  <div class="table-box">
    <div class="table-top-box">
      <el-button type="primary" @click="handleClick(0)">查看订单</el-button>
      <el-button type="primary" @click="handleClick(1)">查看会员卡</el-button>
      <el-button type="primary" @click="handleClick(2)">查看优惠卷</el-button>
      <el-button type="primary" @click="handleClick(3)">发送优惠卷</el-button>
      <el-button type="primary" @click="handleClick(4)">近期会员状况</el-button>
      <el-button type="primary" @click="handleClick(4)">导出绑定会员</el-button>
    </div>
    <BaseTable
      :columns="columns"
