<template>
  <BaseFilterBox>
    <el-form class="filter-form" ref="formInstance" inline :model="store.queryParams" label-width="80px" inline-message>
      <BaseFormItem w="120px" label="姓名" v-model="store.queryParams.keyword" placeholder="" />
      <BaseFormItem w="120px" label="手机号" v-model="store.queryParams.keyword" placeholder="" />
      <BaseFormItem w="120px" label="积分" v-model="store.queryParams.keyword" placeholder="" />
      <BaseFormItem>
        <el-date-picker
