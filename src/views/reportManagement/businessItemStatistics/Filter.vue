<template>
  <BaseFilterBox>
    <el-form class="filter-form" ref="formInstance" inline :model="store.queryParams" label-width="80px" inline-message>
      ...
      <BaseSelect v-model="store.queryParams.category" label="支付类型" :options="STATUS" prop="category" />
      <BaseFormItem w="120px" v-model="store.queryParams.keyword" placeholder="请输入技师工号" />
    </el-form>
