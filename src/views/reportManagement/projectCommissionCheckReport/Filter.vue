<template>
  <BaseFilterBox>
    <el-form class="filter-form" ref="formInstance" inline :model="store.queryParams" label-width="80px" inline-message>
      ...
      <BaseSelect v-model="store.queryParams.category" label="部门" :options="STATUS" prop="category" />
      <BaseFormItem label="技师工号" v-model="store.queryParams.keyword" placeholder="输入技师工号" />
    </el-form>
